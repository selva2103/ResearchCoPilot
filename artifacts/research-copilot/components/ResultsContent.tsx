...
// TODO: PubMed integration — papers are now live via searchPubMed().
// Datasets will be extended with GEO / SRA / Europe PMC results.
    ...
    <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-800/60 overflow-hidden shadow-sm backdrop-blur-sm">
      ...
      {papers.length === 0 ? (
        ...
        <ul className="divide-y divide-slate-100 dark:divide-slate-700/50">
          {papers.map((paper) => (
            <li key={paper.pmid} className="px-5 py-4 flex gap-3 items-start">
              <span className="mt-1 h-2 w-2 rounded-full shrink-0 bg-rose-500" />
      ...
      <div className="px-5 py-3 border-t border-slate-100 dark:border-slate-700/50">
        <p className="text-xs text-slate-400 dark:text-slate-500 italic">
          Live data from PubMed — powered by NCBI ESearch &amp; ESummary
        </p>
      </div>
    </div>
  );
